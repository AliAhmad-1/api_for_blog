...
class PostSerializer(TaggitSerializer,serializers.ModelSerializer):
    ...
    liked_users=serializers.SerializerMethodField('get_liked_users')

    class Meta:
        model=Post
        fields=['uid','title','slug','status','text','publish','created','updated','author','post_comments','likes_count','liked_users','tags']

    def get_likes_count(self,obj):
        return obj.users_like.count()

    def get_liked_users(self,obj):
        return [user.username for user in obj.users_like.all()]
